...
Those endpoints work fine, but there are two things missing: publishedDate as String (instead of long) and descending order in rating. It is going to be finished at 100% in the next few days. 
